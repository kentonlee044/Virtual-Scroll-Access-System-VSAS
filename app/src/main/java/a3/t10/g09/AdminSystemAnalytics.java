...
public class AdminSystemAnalytics {
    ...
    public AdminSystemAnalytics(Scanner scanner) {
    ...
    private void displayScrolls(List<Scroll> scrollsToDisplay, String title) {
        while (true) {
            ...
            System.out.println(TABLE_SEPARATOR);
            System.out.println(String.format(TABLE_HEADER_FORMAT, "OWNER ID", "CATEGORY ID", "FILENAME", "UPLOADS",
                    "DOWNLOADS", "UPLOAD DATE"));
            System.out.println(TABLE_SEPARATOR);
            ...
            for (Scroll scroll : scrollsToDisplay) {
                ...
                String date = scroll.getUploadDate() == null || scroll.getUploadDate().isEmpty() ? "N/A"
